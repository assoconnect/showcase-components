...
var ListItem = (0, _styledComponents["default"])(_gatsby.Link)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n  display: flex;\n  margin-bottom: 40px;\n  align-items: center !important;\n  @media screen and (max-width: 1200px) {\n    flex-direction: column;\n    align-items: start !important;\n  }\n"])));
exports.ListItem = ListItem;

var MiniImage = _styledComponents["default"].div(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n  flex: 0 0 130px;\n  @media screen and (max-width: 1200px) {\n    flex: 0 0 65px;\n    margin: auto;\n    width: 100%;\n    max-width: 180px;\n  }\n\n  background-image: url(", ");\n  height: 60px;\n  background-size: cover;\n  background-position: center;\n  width: 164px;\n"])), function (props) {
  return props.image;
});

exports.MiniImage = MiniImage;

var Name = _styledComponents["default"].div(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n  flex: 1;\n  margin: auto;\n  font-size: 14px;\n  line-height: 17px;\n  font-weight: bold;\n  color: #939393;\n  font-family: ", ";\n  font-weight: bolder;\n  padding-left: 10px;\n  @media screen and (max-width: 1200px) {\n    margin-top: 10px;\n    max-width: 180px;\n    padding-left: 0;\n  }\n"])), _.UI.fonts.family.roboto);
