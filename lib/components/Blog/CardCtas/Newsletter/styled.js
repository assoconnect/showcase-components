...
var Title = _styledComponents["default"].span(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n  flex: 0 0 calc(100% - 70px);\n  font-size: 28px;\n  line-height: 37px;\n  font-weight: 900;\n  padding-left: 10px;\n  color: #fff;\n"])));

exports.Title = Title;

var IconWrap = _styledComponents["default"].div(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n  background: #fff;\n  border-radius: 50%;\n  flex: 0 0 70px;\n  height: 70px;\n  align-items: center !important;\n  justify-content: center !important;\n  display: inline-flex !important;\n  margin: auto;\n  > svg {\n    width: 40px;\n    overflow: hidden;\n    vertical-align: middle;\n  }\n"])));

exports.IconWrap = IconWrap;

var SubNews = _styledComponents["default"].div(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["\n  font-size: 12px;\n  padding-left: 10px;\n  margin-top: 5px;\n"])));

exports.SubNews = SubNews;

var EmailInput = _styledComponents["default"].input(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["\n  width: 100%;\n  border: 0;\n  border-radius: 0;\n  border-bottom: solid 1px #fff;\n  background: 0;\n  padding: 10px;\n  color: #fff !important;\n  margin: 40px 0 20px;\n  ::placeholder {\n    /* Chrome, Firefox, Opera, Safari 10.1+ */\n    color: #fff !important;\n    opacity: 1; /* Firefox */\n  }\n  :-ms-input-placeholder {\n    /* Internet Explorer 10-11 */\n    color: #fff !important;\n  }\n  ::-ms-input-placeholder {\n    /* Microsoft Edge */\n    color: #fff !important;\n  }\n"])));
