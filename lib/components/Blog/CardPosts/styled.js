...
exports.ReadingTime = exports.CardPostFooter = exports.Meta = exports.Title = exports.FrontMatterBlock = exports.FrontMatter = exports.Thumbnail = exports.Wrapper = void 0;
...
var FrontMatterBlock = _styledComponents["default"].div(_templateObject4(), function (props) {
  return props.featured ? '25px' : '25px 25px 100px';
});

exports.FrontMatterBlock = FrontMatterBlock;

var Title = _styledComponents["default"].h2(_templateObject5(), function (props) {
...
var Meta = _styledComponents["default"].div(_templateObject6(), function (props) {
  return props.featured ? '20px 0 30px 0' : 'auto 0';
});

exports.Meta = Meta;

var CardPostFooter = _styledComponents["default"].div(_templateObject7());

exports.CardPostFooter = CardPostFooter;

var ReadingTime = _styledComponents["default"].span(_templateObject8(), function (props) {
