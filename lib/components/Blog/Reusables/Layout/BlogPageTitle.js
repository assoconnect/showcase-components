...
var BlogPageTitleStyled = _styledComponents["default"].h1(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n  font-family: ", ";\n  padding: 10px 0px;\n  font-size: 36px;\n  line-height: 48px;\n  font-weight: 900;\n  color: #9b9b9b;\n  width: 100%;\n  padding-right: 15px;\n  @media screen and (max-width: ", ") {\n    padding-right: 0;\n  }\n"])), _.UI.fonts.family.roboto, _.UI.breakpoints.mobile);
