...
var PagerWrap = _styledComponents["default"].ul(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n  display: inline-block;\n  text-align: center;\n  margin: 30px auto;\n  padding: 0;\n"])));

exports.PagerWrap = PagerWrap;

var PagerRule = _styledComponents["default"].span(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n  text-align: center;\n"])));
...
})(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["\n  padding: 5px 8px !important;\n  color: #316bf2;\n  text-decoration: none;\n  line-height: 38px;\n  background-color: transparent;\n  font-family: ", ";\n  &.active {\n    color: white !important;\n  }\n"])), _2.UI.fonts.family.roboto);
exports.PagerLink = PagerLink;

var PagerNextPrev = _styledComponents["default"].li(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["\n  float: none;\n  display: inline-block;\n  margin: 5px;\n  padding: 0 7px;\n  font-family: ", ";\n\n  &.active,\n  &:hover {\n    border-radius: 22.5px;\n    background-color: #316bf2;\n    color: #fff;\n  }\n  &:hover ", " {\n    display: none !important;\n  }\n  &:hover ", " {\n    display: inline-flex !important;\n  }\n  &:hover ", " {\n    color: #fff;\n  }\n"])), _2.UI.fonts.family.roboto, ArrowBlue, ArrowWhite, PagerLink);

exports.PagerNextPrev = PagerNextPrev;

var PagerNum = _styledComponents["default"].li(_templateObject7 || (_templateObject7 = _taggedTemplateLiteral(["\n  width: 38px;\n  height: 38px;\n  text-align: center;\n  display: inline-block;\n  margin: 5px;\n  &.active,\n  &:hover {\n    border-radius: 22.5px;\n    background-color: #316bf2;\n    color: #fff;\n  }\n  &.active,\n  &:hover ", " {\n    color: #fff;\n  }\n"])), PagerLink);
...
var Pager = function Pager(_ref6) {
  ...
  return /*#__PURE__*/_react["default"].createElement(PagerWrap, null, /*#__PURE__*/_react["default"].createElement(PagerNextPrev, null, previousPagePath && /*#__PURE__*/_react["default"].createElement(PagerLink, {
    ...
    return /*#__PURE__*/_react["default"].createElement(PagerNum, {
      ...
      circle: true,
      to: "/".concat(pathPrefix, "/").concat(i === 0 ? '' : "page/".concat(i + 1, "/")),
      className: pageNumber === i && 'active'
    }, i + 1));
