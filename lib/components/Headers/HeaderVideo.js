...
var HeaderVideo = function HeaderVideo(_ref) {
  ...
  return /*#__PURE__*/_react["default"].createElement(_react["default"].Fragment, null, /*#__PURE__*/_react["default"].createElement(_reactHelmet.Helmet, null, /*#__PURE__*/_react["default"].createElement("link", {
    ...
    imagesrcset: "".concat(process.env.GATSBY_CDN_HOST, "/").concat(image.src, "-mobile-2x.webp x2, ").concat(process.env.GATSBY_CDN_HOST, "/").concat(src, "-mobile-4x.webp 4x"),
    media: "(max-width: 500px)"
  }), /*#__PURE__*/_react["default"].createElement("link", {
    rel: "preload",
    as: "image",
    href: "".concat(process.env.GATSBY_CDN_HOST, "/").concat(image.src, "-mobile.png"),
    imagesrcset: "".concat(process.env.GATSBY_CDN_HOST, "/").concat(image.src, "-mobile-2x.png x2, ").concat(process.env.GATSBY_CDN_HOST, "/").concat(src, "-mobile-4x.png 4x"),
    media: "(max-width: 500px)"
  }), /*#__PURE__*/_react["default"].createElement("link", {
    rel: "preload",
    as: "image",
    href: "".concat(process.env.GATSBY_CDN_HOST, "/").concat(image.src, ".webp"),
    imagesrcset: "".concat(process.env.GATSBY_CDN_HOST, "/").concat(image.src, "-2x.webp x2, ").concat(process.env.GATSBY_CDN_HOST, "/").concat(src, "-4x.webp 4x")
  }), /*#__PURE__*/_react["default"].createElement("link", {
    rel: "preload",
    as: "image",
    href: "".concat(process.env.GATSBY_CDN_HOST, "/").concat(image.src, ".png"),
    imagesrcset: "".concat(process.env.GATSBY_CDN_HOST, "/").concat(image.src, "-2x.png x2, ").concat(process.env.GATSBY_CDN_HOST, "/").concat(src, "-4x.png 4x")
