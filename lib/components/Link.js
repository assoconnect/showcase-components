...
var getNoopener = function getNoopener(target) {
...
var Link = function Link(_ref6) {
  ...
  if (href && href.indexOf('#') === 0) {
    return /*#__PURE__*/_react["default"].createElement(ScrollStyled, {
      ...
      var noopener = getNoopener(target);
      ...
      return /*#__PURE__*/_react["default"].createElement(Gatsbytyled, _extends({
        ...
        target = target || '_blank'; // Noopener noreferre To avoid the warning "Using target="_blank" without rel="noopener noreferrer" is a security risk: see https://mathiasbynens.github.io/rel-noopener..."

        var _noopener = getNoopener(target);
