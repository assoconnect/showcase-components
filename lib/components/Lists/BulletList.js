 ...
 * Style
 */
var BulletListDot = _styledComponents["default"].span(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n  height: 8px;\n  width: 8px;\n  border-radius: 50%;\n  margin-top: 6px;\n  background-color: ", ";\n"])), _.UI.colors.turquoise);

var BulletListSlideTextStyled = _styledComponents["default"].div(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n  flex: 1;\n  margin-left: 1rem;\n"])));

var BulletListSlideItemStyled = _styledComponents["default"].li(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n  margin: 3rem 0;\n  display: flex;\n  align-items: flex-start;\n"])));
/**
 * Component
 */
