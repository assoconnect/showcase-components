 ...
 * Helpers css
 */
var navigationWhiteCss = (0, _styledComponents.css)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n  background-color: ", ";\n\n  > .navigation__arrow .svg--color-primary,\n  .navigation__logo .svg--color-primary {\n    fill: ", ";\n  }\n  .navigation__buttons .button--theme-line-white {\n    color: ", ";\n    border-color: ", ";\n  }\n  .navigation__inner {\n    opacity: 1;\n    color: ", ";\n\n    &:hover {\n      color: ", ";\n\n      > .navigation__arrow .svg--color-primary {\n        fill: ", ";\n      }\n    }\n    .navigation__arrow {\n      opacity: 1;\n\n      .svg--color-primary {\n        fill: ", ";\n      }\n    }\n  }\n"])), _.UI.colors.white, _.UI.colors.blue, _.UI.colors.middleGrey, _.UI.colors.middleGrey, _.UI.colors.middleGrey, _.UI.colors.blue, _.UI.colors.blue, _.UI.colors.middleGrey);
var navigationFixedCss = (0, _styledComponents.css)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n  @media screen and (min-width: ", ") {\n    position: fixed;\n    box-shadow: 0 1px 14px 0 rgba(0, 0, 0, 0.19);\n    ", ";\n  }\n"])), _.UI.breakpoints.mobile, navigationWhiteCss);
var navigationInnerFixedCss = (0, _styledComponents.css)(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n  @media screen and (min-width: ", ") {\n    && {\n      height: 60px;\n      margin-bottom: 0;\n      align-items: center;\n    }\n  }\n"])), _.UI.breakpoints.mobile);
/**
 * Style
 */

var NavigationMargin = _styledComponents["default"].div(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n  @media screen and (max-width: ", ") {\n    height: 59px;\n  }\n  @media screen and (min-width: ", ") {\n    height: 100px;\n  }\n"])), _.UI.breakpoints.mobile, _.UI.breakpoints.mobile);

var NavigationStyled = _styledComponents["default"].nav(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["\n  transition: background-color ease-out 0.2s;\n  background-color: ", ";\n  position: absolute;\n  top: 0;\n  left: 0;\n  width: 100%;\n  z-index: 20;\n  padding-left: 2.5rem;\n\n  /* White mode */\n  ", ";\n  /* Scroll Fixed (only desktop mode) */\n  ", ";\n  /* Mobile mode */\n  @media screen and (max-width: ", ") {\n    padding-left: 0;\n    transition: all ease-out 0.2s;\n    ", ";\n    position: fixed;\n    bottom: 0;\n    ", ";\n  }\n"])), _.UI.colors.blue, function (_ref) {
...
})(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["\n  /* Specific style for all features */\n  .navigation__child--all-features {\n    color: ", ";\n    font-weight: ", ";\n\n    /* Desktop mode */\n    @media screen and (min-width: ", ") {\n      border-top: 1px solid ", ";\n      text-align: center;\n      padding-top: 18px;\n      margin-top: 0;\n    }\n  }\n\n  /* Desktop mode */\n  @media screen and (min-width: ", ") {\n    && {\n      height: 85px;\n      margin-bottom: 15px;\n    }\n  }\n  /* Mobile mode */\n  @media screen and (max-width: ", ") {\n    height: calc(100% - 60px);\n    margin-top: 60px;\n    overflow-y: scroll;\n  }\n  /* Scroll fixed (only desktop mode) */\n  ", ";\n"])), _.UI.colors.darkGrey, _.UI.fonts.weight.bold, _.UI.breakpoints.mobile, _.UI.colors.extraLightGrey, _.UI.breakpoints.mobile, _.UI.breakpoints.mobile, function (_ref4) {
...
var NavigationChildTitle = _styledComponents["default"].div(_templateObject9 || (_templateObject9 = _taggedTemplateLiteral(["\n  margin: 18px 0;\n  font-family: ", ";\n  font-weight: ", ";\n  color: ", ";\n  font-size: 14px;\n\n  /* Mobile mode */\n  @media screen and (max-width: ", ") {\n    width: 270px;\n    margin: 25px auto 0;\n  }\n"])), _.UI.fonts.family.roboto, _.UI.fonts.weight.bold, _.UI.colors.darkGrey, _.UI.breakpoints.mobile);
/**
 * Component
 */
...
var Navigation = /*#__PURE__*/function (_Component) {
  ...
  function Navigation() {
    ...
    _defineProperty(_assertThisInitialized(_this), "getNavigationLogoSrc", function (navigationIsFixed) {
      ...
      return navigationIsFixed ? "common/logo/".concat((0, _translations.formatMessage)('site_name', translations), "-simple") : "common/logo/".concat((0, _translations.formatMessage)('site_name', translations));
    });
