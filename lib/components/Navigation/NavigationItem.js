 ...
 * Style
 */
var NavigationItemStyled = _styledComponents["default"].div(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n  display: inline-block;\n  position: relative;\n\n  /* Show children */\n  &:hover .navigation__children {\n    visibility: visible;\n    opacity: 1;\n  }\n  /* Mobile mode */\n  @media screen and (max-width: ", ") {\n    display: block;\n    text-align: center;\n    margin-top: 40px;\n    margin-bottom: 15px;\n\n    &:first-child {\n      margin-top: 65px;\n    }\n  }\n"])), _.UI.breakpoints.mobile);

var NavigationItemInner = _styledComponents["default"].div(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n  display: inline-block;\n  font-family: ", ";\n  font-weight: ", ";\n  font-size: 14px;\n  margin: 0 26px;\n  cursor: pointer;\n  letter-spacing: 0.02px;\n  color: ", ";\n  transition: all linear 0.2s;\n  opacity: 0.7;\n  text-align: left;\n\n  &:hover {\n    opacity: 1;\n\n    .navigation__arrow {\n      opacity: 1;\n    }\n  }\n  /* Mobile mode */\n  @media screen and (max-width: ", ") {\n    font-weight: ", ";\n    display: flex;\n    flex-direction: row !important; /* Force row direction in mobile mode */\n    align-items: center;\n    margin: auto;\n    width: 260px;\n    font-size: 17px;\n    padding-bottom: 15px;\n  }\n"])), _.UI.fonts.family.roboto, _.UI.fonts.weight.light, _.UI.colors.white, _.UI.breakpoints.mobile, _.UI.fonts.weight.normal);
...
})(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["\n  /* Desktop mode */\n  @media screen and (min-width: ", ") {\n    background-color: ", ";\n    border-radius: 10px;\n    white-space: nowrap;\n    position: relative;\n    box-shadow: ", ";\n    flex-wrap: wrap;\n\n    &:before {\n      top: -6px;\n      left: 50%;\n      margin-left: -10px;\n      position: absolute;\n      width: 0;\n      height: 0;\n      border-style: solid;\n      border-width: 0 15px 10px;\n      border-color: transparent transparent ", " transparent;\n      content: ' ';\n    }\n  }\n  /* Mobile mode */\n  @media screen and (max-width: ", ") {\n    padding-bottom: 22px;\n  }\n"])), _.UI.breakpoints.mobile, _.UI.colors.white, _.UI.shadows.slider, _.UI.colors.white, _.UI.breakpoints.mobile);
/**
 * Component
 */
