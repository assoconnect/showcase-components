 ...
 * Style
 */
var navigationToggleWhiteCss = (0, _styledComponents.css)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n  background-color: ", ";\n  box-shadow: 0 1px 14px 0 rgba(0, 0, 0, 0.19);\n"])), _.UI.colors.white);
...
var NavigationToggleBurger = _styledComponents["default"].div(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n  margin-left: auto;\n  width: 30px;\n  height: 30px;\n  display: flex;\n  flex-direction: column;\n  justify-content: space-between;\n  cursor: pointer;\n  transition: transform 330ms ease-out;\n\n  /* Mobile navigation open */\n  ", ";\n"])), function (_ref2) {
  var navigationMobileIsOpened = _ref2.navigationMobileIsOpened;
  return navigationMobileIsOpened && "transform: rotate(-45deg);";
});

var NavigationToggleBurgerLine = _styledComponents["default"].div(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["\n  border-radius: 5px;\n  width: 100%;\n  height: 6px;\n\n  &.navigation__line--half {\n    width: 50%;\n  }\n  &.navigation__line--start {\n    transition: transform 330ms cubic-bezier(0.54, -0.81, 0.57, 0.57);\n    transform-origin: right;\n\n    /* Mobile navigation open */\n    ", ";\n  }\n  &.navigation__line--end {\n    align-self: flex-end;\n    transition: transform 330ms cubic-bezier(0.54, -0.81, 0.57, 0.57);\n    transform-origin: left;\n\n    /* Mobile navigation open */\n    ", ";\n  }\n  /* White mode */\n  background-color: ", ";\n"])), function (_ref3) {
