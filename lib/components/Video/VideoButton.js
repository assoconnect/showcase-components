...
var VideoButtonWrapper = _styledComponents["default"].div(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n  position: fixed;\n  top: 100vh;\n  left: 50%;\n  transform: translate(-50%, -50%);\n  z-index: 1;\n"])));

var animationCall = (0, _styledComponents.css)(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n  animation: ", " 2.3s ease-in-out infinite;\n"])), animationVideoButton);

var Button = _styledComponents["default"].div(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n  font-family: ", ";\n  font-weight: ", ";\n  font-size: 0.85rem;\n  color: ", ";\n  text-align: center;\n  height: 8.235rem;\n  width: 8.235rem;\n  padding: 0.95rem 1.176rem;\n  border-radius: 50%;\n  background-color: ", ";\n  cursor: pointer;\n  ", "\n"])), _.UI.fonts.family.roboto, _.UI.fonts.weight.normal, _.UI.colors.white, _.UI.colors.turquoise, function (_ref) {
