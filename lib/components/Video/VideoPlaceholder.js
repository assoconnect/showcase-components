 ...
 * Style
 */
var VideoPlaceholderWrapper = _styledComponents["default"].div(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n  margin-top: 20px;\n  position: relative;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  flex-direction: column;\n  width: 100%;\n  height: auto;\n  padding-top: 56.25%;\n  background: #4174eb;\n  background-size: cover;\n  cursor: pointer;\n"])));
...
var PlayButton = (0, _styledComponents["default"])(_.Svg)(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n  svg {\n    position: absolute;\n    top: 35%;\n    left: 50%;\n    transform: translateX(-50%);\n    padding-bottom: 25px;\n    width: 20%;\n    height: auto;\n  }\n  svg:hover path {\n    opacity: 0.95;\n  }\n  path:first-child {\n    transition: 0.3s;\n    opacity: 0.75;\n  }\n  path:nth-child(2) {\n    fill: #fff;\n  }\n"])));
var TitleStyled = (0, _styledComponents.css)(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n  display: flex;\n  position: absolute;\n  width: 100%;\n  margin: 0;\n  color: #fff;\n  font-family: ", ";\n  font-size: 1.5em;\n  font-weight: 600;\n  justify-content: center;\n  text-align: center;\n  @media screen and (max-width: 768px) {\n    font-size: 0.8em;\n  }\n"])), _.UI.fonts.family.roboto);

var TitleStart = _styledComponents["default"].p(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["\n  ", "\n  top: 65%;\n"])), TitleStyled);

var TitleEnd = _styledComponents["default"].p(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["\n  ", "\n  top: 75%;\n"])), TitleStyled);
/**
 * Component
 */
  ...
  _createClass(VideoPlaceholder, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          _this$props$placehold = _this$props.placeholderSrc,
          placeholderSrc = _this$props$placehold === void 0 ? 'components/video/video-placeholder' : _this$props$placehold;
